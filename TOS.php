            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-11 mx-auto px-0">
                        <h4 class="heading text-green">Terms and Conditions</h4>
                        <p class="main_para text-black mt-lg-4 mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
